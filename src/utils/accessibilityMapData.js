import {
  ACCESSIBILITY_MAP_DATE_PATTERN as DATE_PATTERN,
  ACCESSIBILITY_MAP_DEFAULT_VIEWPORT as MAP_DEFAULT_VIEWPORT,
  ACCESSIBILITY_MAP_PERSONAS as MAP_PERSONAS,
  COMMUTABLE_FILTER_ID,
  DEFAULT_COMMUTABLE_DISTANCE_KM,
  DEFAULT_COMMUTABLE_MINUTES,
  FILTER_ALL_VALUE,
  MAX_DISPLAY_COMMUTE_MINUTES,
  REGION_ALIASES
...
export const getScoreNumber = (value) => (typeof value === 'number' && Number.isFinite(value) ? value : null);
...
export const normalizeProfiles = (profiles, selectedProfile) =>
...
export const buildMapViewport = (jobs, selectedJob) => {
...
export const buildMapMarkers = (jobs, selectedJobId) =>
  jobs
...
export const buildSupportAgencyMarkers = (agencies) =>
  agencies
...
export const buildFilterGroups = (selectedFilters, optionState) => [
  {
...
export const filterJobsByMapSearchQuery = (jobs, searchQuery) => {
...
export const sortMapJobs = (jobs, sortMode) => {
